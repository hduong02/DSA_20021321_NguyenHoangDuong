...
public class MergeSort {
    ...
    // is a[i] < a[j]?
    private static boolean less(int a, int b, Comparator comparator) {
    ...
    private static void merge(int[] src, int[] dst, int lo, int mid, int hi, Comparator comparator) {
    ...
    private static void sort(int[] src, int[] dst, int lo, int hi, Comparator comparator) {
        // if (hi <= lo) return;
        if (hi <= lo + CUTOFF) {
    ...
    // sort from a[lo] to a[hi] using insertion sort
    private static void insertionSort(int[] a, int lo, int hi, Comparator comparator) {
        for (int i = lo; i <= hi; i++)
